...
Planet::Planet(double size, float distanceFromSun, float axisRotationSpeed, float orbitRotationSpeed) :
	r(255), g(0), b(0), radius(size), distanceFromSun(distanceFromSun), axisRotationSpeed(axisRotationSpeed),
	orbitRotationSpeed(orbitRotationSpeed), axisRotation(0.0f), orbitRotation(0.0f){}
...
{
	// update the axis and orbit rotation variables based on the amount of time 
	// that has passed between drawring consective frames and the speed at which
