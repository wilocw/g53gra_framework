...
public:
	...
	Planet(double size, float distanceFromSun, float axisRotationSpeed, float orbitRotationSpeed);
	~Planet(){}

	// a setter function to allow you to change the colour of the plant without
	// passing it via the constructor
